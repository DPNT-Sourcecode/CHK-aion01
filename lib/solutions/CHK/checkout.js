...
module.exports = function checkout (skus) {
    ...
    if(skus != '') {
      ...
      let discountR= Math.floor(quantity.R / 3)* 30;
      let discountU= Math.floor(quantity.U / 3)* 40;
      ...
      total = total - discountA5 - discountA3 - discountB2 - discountF - discountH5 - discountH10 - discountK - discountP - discountQ - discountR- discountU- discountV2- discountV3 ;
